use std::{io::{self, IsTerminal, Read, Write}, process::exit};

use clap::Parser;

#[derive(Parser)]
#[command(version, about = "A very simple cli tool to use the clipboard from terminal, pipe into it to store and run without any args to get the value.")]
struct Cli {
